...
//this function will return the x and y coordinates of the cursor position on the console
...
//set color at current cursor position...(see above for color values)
